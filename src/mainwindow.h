...
private slots:
    ...
    void TFFlagChange(int value);
    void NavFlagChange(int value);
    void OusterFlagChange(int value);
    void LeftLivoxFlagChange(int value);
    void RightLivoxFlagChange(int value);
    void CameraFlagChange(int value);
